...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2018 at 08:46 AM
...
`id` int(11) NOT NULL,
  ...
  `batch_template` varchar(100) NOT NULL,
  `batch_students` int(11) NOT NULL
...
INSERT INTO `batch` (`id`, `batch_code`, `batch_start_date`, `batch_end_date`, `batch_name`, `batch_template`, `batch_students`) VALUES
(1, 'bc180305a', '2018-03-05', '0000-00-00', 'Bootcamp', 'bootcamp', 6),
(2, 'u180325', '2018-03-03', '2018-03-05', 'Unity', 'unity', 5),
(3, 'gr180325', '2018-03-21', '2018-04-29', 'Graphic Design', 'graphic', 15),
(13, 'bc180305b', '2018-03-05', '2018-03-30', 'Bootcamp', 'bootcamp', 10),
(14, 'wd180325', '2018-03-05', '2018-03-30', 'Web Development', 'development', 10);
